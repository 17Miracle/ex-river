...
local user_opts = {
	...
	-- Colors and style
	osc_color = "#002D38", -- accent color of the OSC and title bar
	window_title_color = "#EDE7D4", -- color of the title in borderless/fullscreen mode
	window_controls_color = "#EDE7D4", -- color of the window controls (close, minimize, maximize) in borderless/fullscreen mode
	windowcontrols_close_hover = "#DC312E", -- color of close window control on hover
	windowcontrols_max_hover = "#B28600", -- color of maximize window controls on hover
	windowcontrols_min_hover = "#859900", -- color of minimize window controls on hover
	title_color = "#EDE7D4", -- color of the title (above seekbar)
	cache_info_color = "#ADB8B8", -- color of the cache information
	seekbarfg_color = "#CA4C16", -- color of the seekbar progress and handle
	seekbarbg_color = "#647A82", -- color of the remaining seekbar
	seekbar_cache_color = "#ADB8B8", -- color of the cache ranges on the seekbar
	volumebar_match_seek_color = false, -- match volume bar color with seekbar color (ignores side_buttons_color)
	time_color = "#EDE7D4", -- color of the timestamps (below seekbar)
	chapter_title_color = "#ADB8B8", -- color of the chapter title (above seekbar)
	side_buttons_color = "#EDE7D4", -- color of the side buttons (audio, subtitles, playlist, etc.)
	middle_buttons_color = "#EDE7D4", -- color of the middle buttons (skip, jump, chapter, etc.)
	playpause_color = "#EDE7D4", -- color of the play/pause button
	held_element_color = "#586E74", -- color of the element when held down (pressed)
	hover_effect_color = "#CA4C16", -- color of a hovered button when hover_effect includes "color"
	thumbnail_border_color = "#002D38", -- color of the border for thumbnails (with thumbfast)
	thumbnail_border_outline = "#647A82", -- color of the border outline for thumbnails
